...
import { Transportation } from '@/lib/interfaces/transportations'

export const createTransportationForm: IFormField<Transportation>[] = [
	{
		label: 'Date of Entry',
		key: 'date_of_entry',
		type: 'date',
...
export const searchTransportationForm: IFormField<Transportation>[] = [
	{
		label: 'Date of Entry',
		key: 'date_of_entry',
		type: 'date',
...
export const updateTransportationForm: IFormField<Transportation>[] = [
	{
		label: 'Date of Entry',
		key: 'date_of_entry',
		type: 'date',
